...
/* Detect modern C standards (C99, C11, etc.) */
#if defined(__STDC_VERSION__) && __STDC_VERSION__ >= 199901L
#define _ANSI 31459 /* C99 or later */
#endif

/* Original ANSI C detection */
#if __STDC__ == 1
#define _ANSI 31459 /* compiler claims full ANSI conformance */
#endif

/* GCC detection - supports ANSI C even in non-ANSI mode */
#ifdef __GNUC__
#define _ANSI 31459 /* gcc conforms enough even in non-ANSI mode */
#endif

/* TCC (Tiny C Compiler) detection */
#ifdef __TINYC__
#define _ANSI 31459 /* TCC supports ANSI C */
#endif

/* Clang detection (uses GCC-compatible interface) */
#ifdef __clang__
#define _ANSI 31459 /* clang is ANSI compatible */
#endif
